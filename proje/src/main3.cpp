...
#define NUM_OF_FRAMES 286
#define NUM_OF_POINTS 468
#define NUM_OF_UZUV 107
...
int p1Array[NUM_OF_UZUV] = {33, 246, 161, 160, 159, 158, 157, 173, 133, 155, 154, 153, 145, 144, 163, 7, 263, 466, 388, 387, 386, 385, 384, 398, 362, 382, 381, 380, 374, 373, 390, 249, 10, 338, 297, 332, 284, 251, 389, 356, 454, 323, 361, 288, 397, 365, 379, 378, 400, 377, 152, 148, 176, 149, 150, 136, 172, 58, 132, 93, 234, 127, 162, 21, 54, 103, 67, 109, 61, 185, 40, 39, 37, 0, 267, 269, 270, 409, 291, 375, 321, 405, 314, 17, 84, 181, 91, 146, 6, 419, 456, 360, 279, 331, 294, 460, 326, 2, 97, 240, 64, 48, 102, 49, 131, 236, 196};
int p2Array[NUM_OF_UZUV] = {246, 161, 160, 159, 158, 157, 173, 133, 155, 154, 153, 145, 144, 163, 7, 33, 466, 388, 387, 386, 385, 384, 398, 362, 382, 381, 380, 374, 373, 390, 249, 263, 338, 297, 332, 284, 251, 389, 356, 454, 323, 361, 288, 397, 365, 379, 378, 400, 377, 152, 148, 176, 149, 150, 136, 172, 58, 132, 93, 234, 127, 162, 21, 54, 103, 67, 109, 10, 185, 40, 39, 37, 0, 267, 269, 270, 409, 291, 375, 321, 405, 314, 17, 84, 181, 91, 146, 61, 419, 456, 360, 279, 331, 294, 460, 326, 2, 97, 240, 64, 48, 102, 49, 131, 236, 196, 6};
...
init(GLFWwindow* window)
{
    ...
    // Open landmarks file
    FILE* positionsFile = fopen("landmarks_face.txt", "r");
    ...
    while (fscanf(positionsFile, "%f %f %f", &x, &y, &z) == 3) {
        ...
        positions[frameIdx][locIdx] = vec3((x-640.0)/295.0, (295.0-y)/295.0, z);
